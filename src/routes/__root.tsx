...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MedIntel Atlas — AI-Powered Medical Imaging Intelligence" },
      { property: "og:description", content: "Decision-intelligence portal for MRI & CT systems across major vendors. AI-assisted device exploration, comparison and recommendations." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "MedIntel Atlas — AI-Powered Medical Imaging Intelligence" },
      { name: "twitter:description", content: "Decision-intelligence portal for MRI & CT systems across major vendors. AI-assisted device exploration, comparison and recommendations." },
